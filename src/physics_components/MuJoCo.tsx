import { KeyFrame, MuJoCoModel, MuJoCoModelProps, MuJoCoProvider } from '@vuer-ai/mujoco-ts';
import { useCallback, useEffect, useState } from 'react';
import { ClientEvent, useSocket, VuerProps } from '../vuer';
import { UpsertOp } from '../vuer/sceneGraph/eventHelpers';
...
export type MuJoCoProps = VuerProps<MuJoCoModelProps & {
  /**
