...
const useWebSocket = ruw.default;
...
export function WebSocketProvider(
  ...
  const ops = useMemo(
    ...
    [queries.reconnect, queries.interval, shouldReconnect.current],
  );

  const { sendMessage, readyState } = useWebSocket(
    socketURI, ops, !!socketURI && connectWS,
  );
  ...
  const contextValue = useMemo(() => {
    return { sendMsg, uplink, downlink };
  }, [readyState]) as SocketContextType;
